...
const RailwayDetail = () => {
    ...
    const item = transport.railway.find(t => createSlug(t.name) === id);
    ...
    const features = [
        { icon: <FiShield />, title: 'Safe Journey', desc: 'Secure and monitored travel experience' },
        { icon: <FiClock />, title: 'Punctual', desc: 'Adhering to strict schedules' },
        { icon: <FiUsers />, title: 'Comfort Seating', desc: 'Spacious seating for a relaxing trip' },
        { icon: <FiMapPin />, title: 'Scenic Routes', desc: 'Enjoy the best views on the way' }
    ];
            ...
            <div className="bg-gray-50 border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <button
                        ...
                        className="flex items-center gap-2 text-gray-600 hover:text-green-600 transition font-medium mb-4"
                    >
                        <FiArrowLeft /> Back to Railway Booking
                    </button>
                    <div className="flex items-center gap-3 text-sm">
                        <Link to="/" className="text-gray-500 hover:text-green-600 transition">Home</Link>
                        <span className="text-gray-300">/</span>
                        <Link to="/railway-booking" className="text-gray-500 hover:text-green-600 transition">Railway</Link>
                        <span className="text-gray-300">/</span>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                {item.images.map((img, idx) => (
                                    <button
                                        ...
                                        className={`aspect-square rounded-2xl overflow-hidden border-2 transition ${selectedImage === idx ? 'border-green-500 shadow-lg' : 'border-gray-200 hover:border-gray-300'}`}
                                    >
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Pricing */}
                        <div className="bg-gradient-to-br from-green-500/5 to-green-500/10 rounded-3xl p-8 border border-green-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {features.map((feature, idx) => (
                                <div key={idx} className="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-3">
                                    <div className="w-12 h-12 bg-green-500/10 text-green-500 rounded-xl flex items-center justify-center text-xl">
                                        {feature.icon}
                                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-6">
                            ...
                            <Link
                                to="/booking"
                                className="flex-1 bg-green-600 text-white py-4 rounded-xl font-bold text-center hover:bg-green-700 transition flex items-center justify-center gap-2 shadow-lg shadow-green-200"
                            >
                                <FiCheck /> Book Now
                            </Link>
                        </div>
